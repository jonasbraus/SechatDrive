window.addEventListener("load", function (ev) {
    ...
    if (localStorage["move_origin"] !== "undefined" && localStorage["move_origin"] !== undefined) {
        ...
        <button onclick="on_click_move_here('${element_name}')" style="background-color: transparent; display: flex; justify-content: center; align-items: center; border: 0; gap: 40px; margin-top: 30px;">
...
function on_click_edit(request_folder, element_name) {
    ...
    if (!element_name.includes("trash") && !request_folder.includes("trash")) {
        ...
        <span style="color: white;" class="folderPathFont">${element_name}</span>
            ...
            <div onclick="on_click_restore('${element_name}')" style="width: 90%; display: flex; justify-content: flex-start; align-items: center; gap: 40px; margin-left: 40px;">
