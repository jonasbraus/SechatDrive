...
function on_click_file(request_folder, file_name)
{
        ...
        document.querySelector(".sideBar").style.display === "none")
    {
        ...
        if(file_name.toLowerCase().includes(".png") || file_name.toLowerCase().includes(".jpg") ||file_name.toLowerCase().includes(".jpeg") )
        {
            ...
            <img src='${url}' style="display:block; margin:auto; max-width: 100%; max-height: 80%;">
            `
        }
            ...
            document.querySelector(".modal").style.display = "flex"
            document.querySelector(".modalContent").innerHTML = `
            <iframe src='${url}' style="display:block; margin:auto; max-width: 100%; max-height: 80%; width: 100%; height: 80%;">
            `
        }
        else {
