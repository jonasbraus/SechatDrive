function on_click_edit_share(element, token) {
    ...
    <input id="input_rename" type="text" value="${window.location.origin}/drive/share?token=${token}" class="folderPathFont modalContentInput" style="margin-left: 40px; width: 90%;"/>
